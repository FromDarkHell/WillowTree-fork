...
namespace WillowTree.Plugins
{
    public partial class ucGeneral : UserControl, IPlugin
    {
        ...
        {
            // Example: WillowTree# - Level 52 Hunter (Mordecai) for PC
            this.ParentForm.Text = "WillowTree# - Level " + Level.Value + " " + Class.Text + " (" + CharacterName.Text + ") for " + CurrentWSG.Platform;
        }
