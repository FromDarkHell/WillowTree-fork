    ...
    public partial class WillowTreeMain : Form
    {
        ...
        private void Open_Click(object sender, EventArgs e)
        {
            ...
            if (openDlg.ShowDialog() == DialogResult.OK)
            {
                ...
                ConvertListForEditing(db.WeaponList, ref CurrentWSG.WeaponStrings, ref CurrentWSG.WeaponValues);
                ConvertListForEditing(db.ItemList, ref CurrentWSG.ItemStrings, ref CurrentWSG.ItemValues);
...
//            catch { MessageBox.Show("Couldn't save WSG"); }
        ...
        private void SaveToFile(string filename)
        {
            ...
            RepopulateListForSaving(db.WeaponList, ref CurrentWSG.WeaponStrings, ref CurrentWSG.WeaponValues);
            RepopulateListForSaving(db.ItemList, ref CurrentWSG.ItemStrings, ref CurrentWSG.ItemValues);
            ...
            CurrentWSG.WeaponStrings = null;
            CurrentWSG.WeaponValues = null;
            CurrentWSG.ItemStrings = null;
            CurrentWSG.ItemValues = null;
        ...
        private void optionsToolStripMenuItem_DropDownOpening(object sender, EventArgs e)
        {
            ...
            itemAutoSaveToolStripMenuItem.Checked = GlobalSettings.autoSaveItems;
            backupSaveToolStripMenuItem.Checked = GlobalSettings.backupSaves;
        }
        ...
        private void itemAutoSaveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            GlobalSettings.autoSaveItems = !GlobalSettings.autoSaveItems;
        }
        private void backupSaveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            GlobalSettings.backupSaves = !GlobalSettings.backupSaves;
        }
