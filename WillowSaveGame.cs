...
namespace WillowTree
{
    ...
    public class WillowSaveGame
    {
        ...
        private static string ReadString(BinaryReader reader, ByteOrder endian)
        {
            ...
            {
                MessageBox.Show("String was not properly terminated with a null character.");
            }
...
//                        uint titleID = GetXboxTitleID(inputWSG);
        ...
        private static BankEntry ReadBankEntry(BinaryReader reader, ByteOrder endian)
        {
            ...
            //
            // I put debug assertions that will only cause a breakpoint when running the willowtree in a debug build.
            ...
            switch (entry.TypeId)
            {
                case 1: // weapon
                    ...
                    break;
                case 2: // item
                    entry.Quantity = (int)reader.ReadByte();
                    break;
                default:
                    entry.Quantity = 0;
                    break;
